...
public class BasicImpl implements Basic {
	...
	//----------------------------------Lấy 1 bản ghi----------------------------------//
	/**
	 * ResultSet để lưu trữ một mảng các kết quả của truy vấn
	 */
	@Override
	...
	//---------------------Lấy nhiều bản ghi từ 1 câu lệnh SELECT-------------------//
	@Override
	...
	//----------------Lấy nhiều bản ghi với nhiều câu lệnh SELECT khác nhau----------------//
	@Override
	public ResultSet[] gets(String[] sql) {
